  ...
  return (
    <div>
      ...
      <div className="flex justify-center flex-col items-center">
        <div className=' md:w-170 w-sm bg-zinc-900 rounded-2xl p-5 mt-5 gap-2'>
          <div className='ml-2 font-bold'>BLOCKCHAIN-BASED DIGITAL IDENTITY VERIFICATION SYSTEM FOR E-COMMERCE</div>
          <div className='p-2'> &#8226; Designed and developed a blockchain-based digital identity verification system for e-commerce, enhancing user security, privacy, and control through smart contracts and decentralized storage.</div>
          <div className='p-1'> &#8226; Implemented cryptographic protocols and machine learning tools (Python, Solidity, scikit-learn, pandas, NumPy) to automate fraud detection, eliminate third-party data reliance, and build trust in online transactions.</div>
        </div>
        <div className=' md:w-170 w-sm bg-zinc-900 rounded-2xl p-5 mt-5 gap-2'>
        ...
        <div className=' md:w-170 w-sm bg-zinc-900 rounded-2xl p-5 mt-5'>
